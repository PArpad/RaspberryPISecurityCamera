...
namespace RaspberryPISecurityCam.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            {
                var secAppUserToUpdate = _context.SecAppUser.FirstOrDefault(x => x.Name == user.UserName);
                secAppUserToUpdate.Email = model.Email;
                _context.SecAppUser.Update(secAppUserToUpdate);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("RaspberryPISecurityCam"),
